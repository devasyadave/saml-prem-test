            ...
            <div class="tile">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <h4>Step 3:</h4>
                        <ul>
                            <li>Do not forget to click <b>Save</b> before checking if the plugin is configured correctly
                                by clicking <b>Test Configuration</b> button.
                            </li>
                        </ul>
                        ...
                        <h4>Step 4:</h4>
                        <ul>
                            <li>Your users can initiate the Single Sign On flow by clicking on the login button
                                generated on your login page. If you do not have this page yet, run <i>php artisan
                                    make:auth</i> & <i>php artisan migrate</i> to generate the authentication module.
                            </li>
                        </ul>
                        ...
                        <br/><br/>
                        <ul>
                            <li>You can create your own Single Sign On link. Make sure it redirects you to the SSO link
                                : <b><?php echo $_SERVER['HTTP_HOST'] . '/login.php';?></b>. Refer to the example given
                                below :
                            </li>
