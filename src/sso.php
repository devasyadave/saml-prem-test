        ...
        if (array_key_exists('SAMLResponse', $_REQUEST) && !empty($_REQUEST['SAMLResponse'])) {
            try {
                ...
                if (strcasecmp($relayStateUrl, Constants::TEST_RELAYSTATE) == 0) {
                    ...
                    $_SESSION['slo_url'] = $pluginSettings->getSamlLogoutUrl();
                    ...
                    $encrypted_mail = urlencode(AESEncryption::encrypt_data($_SESSION['email'][0], "M12K19PV"));
                    $encrypted_name = urlencode(AESEncryption::encrypt_data($_SESSION['username'][0], "M12K19PV"));
