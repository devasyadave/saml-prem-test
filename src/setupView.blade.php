                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form method="POST" action="" id="saml_form">
                                ...
                                <h4 class="column-name">Identity Provider Settings</h4>
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="x509_certificate"
                                              ...
                                              rows="5"><?php echo DB::get_option('saml_x509_certificate');?></textarea>
                        ...
                        <div class="col-lg-4 offset-lg-1">
                            <h4 class="column-name">Service Provider Settings</h4>
                            <br>
                            <div class="form-group">
                            ...
                            <h4 class="column-name">Attribute Mapping</h4>
                            ...
                            <form id="attrs_form" method="post" action="">
                                ...
                                <h4 class="column-name">Custom Attribute Mapping</h4>
                                    ...
                                    <div class="form-inline">
                                        <div class="form-group" style="padding-bottom: 5px">
                                            <input type="text" class="form-control" id="attribute_name"
                                                   name="attribute_name[]" placeholder="eg. Username"
